report 50206 "Sales - Invoice spec"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SalesInvoice.rdl';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                        ...
                        dataitem(ShipmentDatas; "Integer")
                        {
                            ...
                            begin
                                ...
                                if ShipmentInvoiced.Count < 1 then
                                    CurrReport.Break;
                                SetRange(Number, 1, Round(ShipmentInvoiced.Count / 3, 1, '>'));
                            end;
                        }
                    ...
                    dataitem(VatCounterLCY; "Integer")
                    {
                        ...
                        column(VATAmtLineVAT1; TempVATAmountLineLCY."VAT %")
                        {
                            DecimalPlaces = 0 : 5;
                        }
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field(IncludeShipmentNo; IncludeShptNo)
                    {
                        ...
                        ToolTip = 'Specifies if you want the report to show the shipment number for each invoice.';
                    }
    ...
    procedure InitializeRequest(NewNoOfCopies: Integer; NewShowInternalInfo: Boolean; NewLogInteraction: Boolean; IncludeShptNo: Boolean; DisplayAsmInfo: Boolean)
    begin
