    ...
    actions
    {
        ...
        area(sections)
        {
            ...
            group(Contract)
            {
                ...
                action(Degressive)
                {
                    Caption = 'Degressive Contract';
                    ApplicationArea = All;
                    Image = ContractPayment;
                    Promoted = true;
                    PromotedCategory = Process;
                    RunObject = page "Degressive Contract List";
                }
                action(OutLocal)
                {
                    Caption = 'Out Of Local Contract';
                    Image = ContractPayment;
                    Promoted = true;
                    PromotedCategory = Process;
                    RunObject = page "Out Of Local Contract List";
                }
                action(Local)
                {
                    Caption = 'Local Contract';
                    Image = ContractPayment;
                    Promoted = true;
                    PromotedCategory = Process;
                    RunObject = page "Local Contract List";
                }
                action(Package)
                {
                    ...
                    Promoted = true;
                    PromotedCategory = Process;
                    RunObject = page "Package Contract List";
                }
            }
            group(Action63)
            {
